...
Use the active lead runtime's configured event-wait cadence. Treat its duration
as cache maintenance for the lead, not as a progress interval for the
assignment.
...
Report meaningful milestones and blockers. Do not narrate quiet ticks. Follow
any higher-priority host-required update interval without treating a user
update as an assignment event, contacting the assignment, or ending its quiet
episode.
