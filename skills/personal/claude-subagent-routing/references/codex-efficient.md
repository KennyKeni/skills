...
- routine `scout`: this lane with `gpt-5.6-luna` at high effort;
- consequential `scout`: the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at medium effort;
- routine `worker`: this lane with `gpt-5.6-luna` at high effort;
- consequential `worker`: the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at high effort;
- every `validator`: a fresh session of the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at high effort.
...
scout through the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at medium effort or the worker
through the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at high effort, passing a compact
...
validation through a fresh session of the Codex Sol lane ([codex-sol.md](codex-sol.md)) with `gpt-5.6-sol` at high effort.

## Select Model And Effort

Use `gpt-5.6-luna` with the effort configured for each role
