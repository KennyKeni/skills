...
subagent, then return to observation. Continue or replace it according to the
main routing continuation rule and its freshness requirement. Interrupt only
the affected subagent and preserve useful evidence before recovery.
