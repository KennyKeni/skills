...
## Worktree, commit, migration, and generated-code rules
...
4. Check the implementation against the originating requirement when one
   exists, including the live issue body and later maintainer-approved
   decisions.
...
There is no repository requirement to use parallel reviewers, a generic smell
baseline, a fixed word limit, an aggregation prompt, or a dedicated review
skill.
