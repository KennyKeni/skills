...
Confirm the repository's enabled merge strategies from settings rather than
assuming.
...
A red pull request is never merged. What the pipeline runs is defined by the
